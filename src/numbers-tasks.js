...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  /* Скалярное произведение двух векторов на плоскости   = ax*bx + ay*by */
...
function isPowerOfTwo(num) {
  /* . Если логарифм числа по основанию два дает целое число, то число является степенью двойки. Например, log216 = 4, значит 16 является степенью двойки. */
